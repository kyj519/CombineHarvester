...
int main()
{
  ...
  ch::Categories cats = {
      {1, "Signal_2016postVFP_El"},
      {2, "Control0_2016postVFP_El"},
  ...
  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "/Vcb_Histos_2016postVFP_El_All_processed.root",
  ...
  TFile output("Vcb_Template_El_2016postVFP.root", "RECREATE");
