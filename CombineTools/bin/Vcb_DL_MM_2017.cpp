...
int main()
{
  ...
  // vector<string> bkg_proc_ttbar = {"JJ_TTLJ","JJ_TTLL","CC_TTLJ","CC_TTLL","BB_TTLJ","BB_TTLL"};
  ...
  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "/Vcb_DL_Histos_2017_MM_processed.root",
  ...
  TFile output("Vcb_Template_2017_MM.root", "RECREATE");
