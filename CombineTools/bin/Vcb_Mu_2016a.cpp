...
int main()
{
    ...
    ch::Categories cats = {
        {1, "Signal_2016preVFP_Mu"},
        {2, "Control0_2016preVFP_Mu"},
  ...
  cb.cp().process(ch::JoinStr({sig_procs, bkg_procs})).AddSyst(cb, "lumi_corr_16_17_18", "lnN", SystMap<era>::init({"2016preVFP"}, 1.006));
    ...
    */
    ...
    cb.cp().backgrounds().ExtractShapes(
        aux_shapes + "/Vcb_Histos_2016preVFP_Mu_All_processed.root",
    ...
    TFile output("Vcb_Template_Mu_2016preVFP.root", "RECREATE");
