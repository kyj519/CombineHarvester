...
int main()
{
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"WtoCB"}, {"2018"}, {"Template_MVA_Score"}, cats);
  //! [part3]
  ...
  cb.AddProcesses({"*"}, {"WtoCB"}, {"2018"}, {"Template_MVA_Score"}, bkg_procs, cats, false);

  cb.AddProcesses({"*"}, {"WtoCB"}, {"2018"}, {"Template_MVA_Score"}, bkg_procs_non_ttbar, cats, false);
  ...
  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "/Vcb_Histos_2018_El_All_processed.root",
  ...
  TFile output("Vcb_Template_El_2018.root", "RECREATE");
