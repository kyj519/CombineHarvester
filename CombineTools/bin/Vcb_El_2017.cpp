...
int main()
{
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"WtoCB"}, {"2017"}, {"Template_MVA_Score"}, cats);
  //! [part3]
  ...
  cb.AddProcesses({"*"}, {"WtoCB"}, {"2017"}, {"Template_MVA_Score"}, bkg_procs, cats, false);

  cb.AddProcesses({"*"}, {"WtoCB"}, {"2017"}, {"Template_MVA_Score"}, bkg_procs_non_ttbar, cats, false);
  ...
  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "/Vcb_Histos_2017_El_All_processed.root",
  ...
  TFile output("Vcb_Template_El_2017.root", "RECREATE");
  ...
  for (auto b : bins)
  {
    ...
    if (datacardFile.is_open())
    {
      ...
      // datacardFile << "experimental group = C_Tag_Extrap_ C_Tag_Interp_ C_Tag_Stat_ C_Tag_XSec_Br_Unc_DYJets_B_ C_Tag_XSec_Br_Unc_DYJets_C_ C_Tag_XSec_Br_Unc_WJets_C_ Jet_En_ Jet_Res_ Mu_Id_ Mu_Iso_ PU_Jet_Veto_ Prefire_ QCDNorm STNorm Trig_ VJetsNorm VVNorm lumi_uncorr_2017 ttVNorm\n";
      datacardFile << "experimental group =  B_Tag_LFStats1_ B_Tag_LFStats2_ B_Tag_CFErr2_ B_Tag_HFStats1_ B_Tag_HFStats2_ Jet_En_ Jet_Res_ Mu_Id_ Mu_Iso_ PU_Jet_Veto_ Prefire_ QCDNorm STNorm Trig_ VJetsNorm VVNorm lumi_uncorr_2017 ttVNorm\n";
