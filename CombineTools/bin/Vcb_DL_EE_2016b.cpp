...
int main()
{
  ...
  //! [part3]
  cb.AddObservations({"*"}, {"WtoCB"}, {"2016postVFP"}, {"BvsC_3rd_4th_Jets_Unrolled"}, cats);
  //! [part3]
  ...
  cb.AddProcesses({"*"}, {"WtoCB"}, {"2016postVFP"}, {"BvsC_3rd_4th_Jets_Unrolled"}, bkg_procs, cats, false);

  // cb.AddProcesses({"*"}, {"WtoCB"}, {"2016postVFP"}, {"BvsC_3rd_4th_Jets_Unrolled"}, bkg_procs_non_ttbar, cats, false);
  ...
  cb.cp().backgrounds().ExtractShapes(
      aux_shapes + "/Vcb_DL_Histos_2016postVFP_EE_processed.root",
  ...
  TFile output("Vcb_Template_EE_2016postVFP.root", "RECREATE");
